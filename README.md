...
curl -L -o AghayeVOIPCalleridFormatter.zip https://github.com/aghayevoip-ir/AGHV-CalleridFormat/archive/refs/heads/main.zip && unzip AghayeVOIPCalleridFormatter.zip && cd AGHV-CalleridFormat-main && sudo bash install.sh
```
